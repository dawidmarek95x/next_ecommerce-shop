...
export type ProductColor = "BLACK" | "PINK" | "PURPLE";
...
export const CategoriesGetBySlugDocument = new TypedDocumentString(`
  ...
  categories(first: $limit, skip: $offset, where: {slug: $slug}) {
	...
	CategoriesGetBySlugQuery,
	CategoriesGetBySlugQueryVariables
>;
export const CategoriesGetlistDocument = new TypedDocumentString(`
  ...
  categories(first: $limit, skip: $offset) {
    ...
    `) as unknown as TypedDocumentString<
	CategoriesGetlistQuery,
	CategoriesGetlistQueryVariables
>;
...
export const ProductsGetByCategorySlugDocument = new TypedDocumentString(`
  ...
  productsConnection(where: {categories_some: {slug: $categorySlug}}) {
	...
	ProductsGetByCategorySlugQueryVariables
>;
