							...
							<div className="text-sm">
								<div className="flex items-center justify-between py-4">
									...
									<p className="small-caps ml-1 text-base font-semibold text-slate-900">
										{formatMoney(cart.total / 100)}
									</p>
								</div>
							</div>
						</div>
						<div className="mt-5 flex justify-end">
							<button className="w-1/2 rounded border border-transparent bg-blue-600 px-6 py-3 font-medium text-slate-50 hover:bg-blue-500 disabled:bg-gray-300 md:w-1/3">
								Checkout
							</button>
						</div>
					</div>
